...
- The agent asks at most one category-critical discovery question before its first search. A shopper's instruction to proceed always overrides further clarification.
